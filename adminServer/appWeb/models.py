...
class Usuario(models.Model):
    usr = models.CharField("Usuario", max_length=16,
                           blank=False, null=False, primary_key=True)
    pwd = models.CharField("Contraseña", max_length=42,
                           blank=False, null=False)
    nombres = models.CharField(
        "Nombre", max_length=20, blank=False, null=False)
    apellidos = models.CharField(
        "Apellido", max_length=20, blank=True, null=False)
